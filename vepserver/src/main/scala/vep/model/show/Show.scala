...
case class ShowForm(canonical: String, title: String, author: String, director: String, company: String, duration: Option[Int], content: Option[String]) extends VerifiableMultiple {
  override def verify: Boolean = {
    ...
    if (StringUtils.isEmpty(director)) {
      addError("director", ErrorCodes.emptyField)
    } else if (director.length > 250) {
...
case class ShowFormBody(title: String, author: String, director: String, company: String, duration: Option[Int], content: Option[String]) {
